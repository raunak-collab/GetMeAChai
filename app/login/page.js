...
const login = () => {
    ...
    return (
        <div className='text-white container mx-auto w-[80vw] py-12'>
            ...
            <div className="flex flex-col gap-2 min-h-screen  items-center p-10 ">
                ...
                <button
                    className="flex items-center text-black w-64 bg-slate-50 border border-gray-50 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 hover:text-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                ...
                <button
                    className="flex items-center text-black w-64 bg-slate-50 border border-gray-30 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 hover:text-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
